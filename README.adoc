...
----
include::finish/src/main/java/io/openliberty/guides/microprofile/InventoryConfig.java[tags=port-number]
----
...
[source, java, indent=0]
----
include::finish/src/main/java/io/openliberty/guides/microprofile/InventoryResource.java[tags=config-port]
----
