...
Last but important, register the custom configuration source. Create a `start/src/main/resources/META-INF/services/org.eclipse.microprofile.config.spi.ConfigSource` file and add the fully qualified class name of the configuration source into it:
