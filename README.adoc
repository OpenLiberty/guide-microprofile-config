...
Create a `CustomConfigSource.java` file in the `start/src/main/java/io/openliberty/guides/config/` folder.
...
To convert configured Strings to an arbitrary class type, such as the `Email` class type, create an `Email` class file in the `start/src/main/java/io/openliberty/guides/config/` folder.
[source, java, indent=0]
----
...
Create `CustomEmailConverter.java` file in the `start/src/main/java/io/openliberty/guides/config` folder.
