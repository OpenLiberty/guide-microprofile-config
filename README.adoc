...
Lastly, it is an important step to register the custom configuration source, create a file called `org.eclipse.microprofile.config.spi.ConfigSource` under `start/src/main/resources/META-INF/services/` directory and add the full class name into it:
...
To register your implementation, create a file called `org.eclipse.microprofile.config.spi.Converter` under `start/src/main/resources/META-INF/services/` directory and add the fully qualified class name of the custom converter into it:
[source, java, indent=0]
----
...
It is crucial to register the custom configuration source and custom converter in the `start/src/main/resources/META-INF/services/` directory, if you miss to complete these steps, the tests will fail.
