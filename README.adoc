...
To use the custom `Email` converter, open the `InventoryConfig.java` file and inject the property:
[source, java, indent=0]
----
include::finish/src/main/java/io/openliberty/guides/microprofile/InventoryConfig.java[tags=custom-converter]
----

Modify the `propertyJsonBuilder()` method to add information about `devEmail` that has the `Email` type.
[source, java, indent=0]
----
include::finish/src/main/java/io/openliberty/guides/microprofile/InventoryConfig.java[tags=propertyJsonBuilder]
----
