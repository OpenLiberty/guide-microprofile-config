...
:page-seo-title: Externalizing configuration for microservices using Eclipse MicroProfile Config
:page-seo-description: A tutorial on how to externalize and inject both static and dynamic configuration properties for Java microservices through configuration sources using Eclipse MicroProfile Config.
