...
Repeat the same in `SystemConfig`.
...
include::finish/src/main/java/io/openliberty/guides/system/SystemConfig.java[]
----
Inject the [hotspot=custom-converter file=4]`io_openliberty_guides_email` property, and add the [hotspot=getEmail file=4]`getEmail()` method.
