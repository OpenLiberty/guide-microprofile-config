...
:page-seo-title: Configuring microservices using MicroProfile Config
:page-seo-description: A tutorial on how to externalize and inject both static and dynamic configuration properties for Java microservices using MicroProfile Config.
